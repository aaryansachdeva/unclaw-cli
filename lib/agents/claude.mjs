...
import { registerAdapter, onPath, runAgentCli, upsertInstructions, writeText, rmDir, INSTRUCTIONS_BODY, claudeSkillMarkdown } from '../installer.mjs';
...
registerAdapter({
  ...
  register({ node, runtime }) {
    ...
    writeText(SKILL, claudeSkillMarkdown(node, runtime)); // /unclaw skill
